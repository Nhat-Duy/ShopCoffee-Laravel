          ...
          <div class="flex-auto p-4">
            <div class="flex flex-row -mx-3">
              <div class="flex-none w-2/3 max-w-full px-3">
                <div>
                  <p class="mb-0 font-sans font-semibold leading-normal text-sm">Lợi nhuận</p>
        ...
        <div class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
          <div class="flex-auto p-4">
            <div class="flex flex-row -mx-3">
              <div class="flex-none w-2/3 max-w-full px-3">
                <div>
                  <p class="mb-0 font-sans font-semibold leading-normal text-sm">Doanh số</p>
                  <h5 class="mb-0 font-bold">
                    {{number_format($doanhso). ' '. 'Đ'}}
        ...
        <div class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
          <div class="flex-auto p-4">
            <div class="flex flex-row -mx-3">
              <div class="flex-none w-2/3 max-w-full px-3">
                <div>
                  <p class="mb-0 font-sans font-semibold leading-normal text-sm">Số lượng bán được</p>
                  <h5 class="mb-0 font-bold">
        ...
        <div class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
          <div class="flex-auto p-4">
            <div class="flex flex-row -mx-3">
              <div class="flex-none w-2/3 max-w-full px-3">
                <div>
                  <p class="mb-0 font-sans font-semibold leading-normal text-sm">Nhập hàng</p>
                  <h5 class="mb-0 font-bold">
                    {{number_format($doanhsonhaphang). ' '. 'Đ'}}
                    {{-- <span class="leading-normal text-sm font-weight-bolder text-lime-500">+5%</span> --}}
                  </h5>
                </div>
              </div>
          ...
          <div class="flex-auto p-4">
            <div class="flex flex-wrap -mx-3">
                <form autocomplete="off" class="flex">
                    @csrf
                    <div class="w-2/4">
                      <p class="mb-2 ml-2">Từ ngày: <input type="text" id="datepicker" class="px-2 py-1 bg-gray-400 border-2 border-black rounded-md"></p>
                      <a class="mb-2 ml-2 inline-block px-6 py-3 font-bold text-center text-white uppercase align-middle transition-all bg-transparent rounded-lg cursor-pointer leading-pro text-xs ease-soft-in shadow-soft-md bg-150 bg-gradient-to-tl from-gray-900 to-slate-800 hover:shadow-soft-xs active:opacity-85 hover:scale-102 tracking-tight-soft bg-x-25" >
                        <input type="button" value="Lọc kết quả" id="btn-dashboard-filter" class="btn btn-info btn-sm">
                      </a>
                      {{-- <input type="button" id="btn-dashboard-filter" class="text-black font-bold btn btn-primary btn-sm " value="Lọc kết quả"> --}}
                    </div>
                    <div class="w-2/4 ml-2">
                      <p class="mb-2">Đến ngày: <input type="text" id="datepicker2" class="px-2 py-1 bg-gray-400 border-2 border-black rounded-md"></p>
                    </div>
                    <div class="w-2/4 ml-2">
                      <p class="mb-2">
                        Lọc theo: 
                        <select class="dashboard_filter px-4 py-2 bg-gray-400 border-2 border-black rounded-md">
                          <option>-- Chọn --</option>
      ...
      <div class="w-full max-w-full px-3 mt-0 lg:w-7/12 lg:flex-none">
        <div class="border-black/12.5 shadow-soft-xl relative z-20 flex min-w-0 flex-col break-words rounded-2xl border-0 border-solid bg-white bg-clip-border">
          <div class="border-black/12.5 mb-0 rounded-t-2xl border-b-0 border-solid bg-white p-6 pb-0">
            <h4 class="text-center text-red-500">Số lượng các sản phẩm đã bán được</h4>
            @foreach($soluong_sanpham as $id_sp => $soluong_sp)
                @php
